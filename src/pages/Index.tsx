    ...
    <>
      ...
      <section className="grid-background min-h-screen flex items-center pt-24 pb-16">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight max-w-4xl mx-auto fade-in-up animate-delay-100">
            Crafting Delightful Digital Experiences
          </h1>
          
          <p className="text-xl md:text-2xl text-accent mb-4 max-w-4xl mx-auto font-medium fade-in-up animate-delay-200">
            Bridging design & engineering to make complex workflows effortless.
          </p>
...
performance and meet business objectives.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center fade-in-up animate-delay-300">
            <Link to="/contact" className="btn-primary text-lg hover:scale-105 transition-transform duration-200">
              Book a free 30-min call
            </Link>
            <a 
              href="#selected-works" 
              className="px-6 py-3 border border-white/20 rounded-md hover:bg-white/5 hover:scale-105 transition-all duration-200 text-lg"
              onClick={(e) => {
                e.preventDefault();
      ...
      <section id="selected-works" className="py-24 bg-black">
        <div className="container mx-auto px-4 md:px-8">
